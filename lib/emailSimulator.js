...
<body>
  <div class="email-container">
    ...
    <div class="email-footer">
      <p style="margin-bottom: 8px; font-size: 12px;">This is an automated operational email from Gym-on-Go.</p>
      <div class="footer-links">
        <a href="mailto:supportgymongo@gmail.com">Contact Support</a> | 
        <a href="http://localhost:3000/partners">Partner Portal</a>
      </div>
      <p style="margin-top: 16px; margin-bottom: 0; font-size: 11px; color: #94a3b8;">&copy; 2026 Gym-on-Go Technologies. All rights reserved.</p>
    </div>
  </div>
</body>
</html>
...
export async function sendSimulatedEmail({ to, subject, body, html }) {
  try {
    ...
    await EmailLog.create({
      to,
      from: process.env.SMTP_FROM || 'system@gymongo.com',
      subject,
      body,
      html: html || '',
    });
    ...
    if (isSmtpConfigured) {
      ...
      await transporter.sendMail({
        from: process.env.SMTP_FROM || '"Gym-on-Go Onboarding" <system@gymongo.com>',
        to,
        subject,
        text: body,
        html: html || undefined,
      ...
      console.log(`--------------------------------------------------`);
      console.log(`TO:      ${to}`);
      console.log(`FROM:    system@gymongo.com`);
